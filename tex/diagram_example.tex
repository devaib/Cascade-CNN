...
\tikzstyle{linepart} = [draw, thick, color=black!90, -latex', dashed]
\tikzstyle{line} = [draw, thick, color=black!90, -latex']
\tikzstyle{ur}=[draw, color=red!60, text centered, minimum height=0.01em]
...
\begin{tikzpicture}[scale=0.7,transform shape]
  ...
  \path [line] (p17.south) --e node [abov] {} (p18) ;
