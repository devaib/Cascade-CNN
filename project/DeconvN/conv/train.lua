...
local trainLogger = optim.Logger(paths.concat(opt.save, 'train_V.log'))
local trainvldLogger = optim.Logger(paths.concat(opt.save, 'trainvld_V.log'))
----------------------------------------------------------------------
...
local function train(trainData)
   ...
   -- save/log current net
     ...
     local filename = paths.concat(opt.save, 'modelV.net')
