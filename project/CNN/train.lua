...
function randlighting(imag)
  local r=torch.randn(3)*0.316227;
  imag= imag+torch.mul(P1,r[1])+torch.mul(P2,r[2])+torch.mul(P3,r[3])
return imag
end
...
local function train(trainData)
   ...
   for t = 1,trainData:size(),opt.batchSize do
      ...
      for i = t,t+opt.batchSize-1 do
         x[idx] = randlighting(randBSC(trainData.data[shuffle[i]]))
