...
local trainLogger = optim.Logger(paths.concat(opt.save, 'train_'..opt.fold..'.log'))
local trainvldLogger = optim.Logger(paths.concat(opt.save, 'trainvld_'..opt.fold..'.log'))
----------------------------------------------------------------------
