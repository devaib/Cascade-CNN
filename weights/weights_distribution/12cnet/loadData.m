...
figure(1), hist(convWeights, 20), title(['convWeights    #',num2str(size(convWeights,1))])
...
xmin =  min(fcWeights1);
strmin = ['Minimum = ',num2str(xmin)];
text(xmin,-100,strmin,'HorizontalAlignment','left');
xmax =  max(fcWeights1);
strmin = ['Minimum = ',num2str(xmax)];
text(xmax,-100,strmin,'HorizontalAlignment','left');

figure(4), hist(fcBias1, 5), title(['fcBias1    #',num2str(size(fcBias1,1))])
xmin =  min(fcBias1);
strmin = ['Minimum = ',num2str(xmin)];
text(xmin,-2.5,strmin,'HorizontalAlignment','left');
xmax =  max(fcBias1);
strmin = ['Minimum = ',num2str(xmax)];
text(xmax,-2.5,strmin,'HorizontalAlignment','left');

figure(5), hist(fcWeights2, 500), title(['fcWeights2    #',num2str(size(fcWeights2,1))])
xmin =  min(fcWeights2);
strmin = ['Minimum = ',num2str(xmin)];
text(xmin,-2.5,strmin,'HorizontalAlignment','left');
xmax =  max(fcWeights2);
...
figure(6), hist(fcBias2, 10), title(['fcBias2    #',num2str(size(fcBias2,1))])
xmin =  min(fcBias2);
strmin = ['Minimum = ',num2str(xmin)];
text(xmin,-1,strmin,'HorizontalAlignment','left');
xmax =  max(fcBias2);
